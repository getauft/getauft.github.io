        ...
        case 1: {
            ...
            switch (1) {
                ...
                case 1: {
                    ...
                    if (pronoun_item.subject_pronoun.toString().toUpperCase() !== "he".toString().toUpperCase() || pronoun_item.subject_pronoun.toString().toUpperCase() !== "she".toString().toUpperCase()){
