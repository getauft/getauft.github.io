...
function getExercise() {
    ...
    document.getElementById("place_answer").innerHTML = '<div class="alert alert-info" role="alert">'+answer+' <button type="button" class="btn btn-info close" value="Озвучить" onclick="speak()"/></div>';
