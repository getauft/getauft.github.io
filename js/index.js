...
function getExercise() {
    ...
    document.getElementById("place_answer").innerHTML = '<div class="alert alert-info" role="alert">'+answer+' <button type="button" class="btn btn-info pull-right" value="Озвучить" onclick="speak()"/></div>';
